...
class Env:
    ...
    def state(self,i):
        ...
        #          p_five]
        state = [self.intervention, self.infection,
                 self.residential, p_r, self.working, p_w,  p_five]
    ...
    def reward(self):
        ...
        df = re.process_file("/Users/d/work/xin/starter-kit/examples/results/cnt_test1.txt")
...
if __name__ == '__main__':
    period = 840
    engine = simulator.Engine(thread_num=1, write_mode="append", specified_run_name="test2")

    # engine = simulator.Engine(thread_num=1, write_mode="write", specified_run_name="test2")
    engine.reset()
    from Q import QLearningTable
    env = Env(engine)
    ...
    for i in range(period):
        ...
        for num in range(100):
            ...
            # print('aa',engine.get_current_hour())
